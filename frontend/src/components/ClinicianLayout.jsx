    ...
    <div className="h-screen w-screen overflow-hidden flex bg-[#121212] text-gray-100 font-sans">
      ...
      <nav className="fixed left-0 top-0 h-screen w-[240px] bg-[#1e1e1e] border-r border-[#333333] flex flex-col h-full py-6 z-50">
        ...
        <div className="px-4 mt-auto">
          <button className="w-full bg-red-500/10 text-red-400 py-2.5 rounded-lg border border-red-500/30 hover:bg-red-500/20 transition-colors flex items-center justify-center gap-2 mb-4 font-bold text-xs tracking-wider uppercase">
          ...
          <div className="pt-3 border-t border-[#333333]">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="min-w-0">
                <div className="font-bold text-sm text-gray-100 truncate">Dr. Chen</div>
